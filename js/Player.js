var Player = function (game, scene, gamepad) {
	...
	/* MESH */
	this.box = BABYLON.Mesh.CreateSphere("player", 12, 5, this.scene);
	this.box.position.y = 3;
	this.body = this.box.setPhysicsState(BABYLON.PhysicsEngine.BoxImpostor, {
		mass: 1,
		friction: 0.5,
		restitution: 0.5
	});
